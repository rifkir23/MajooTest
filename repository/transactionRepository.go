...
type TransactionRepository interface {
	...
	TransactionReportByMerchant(pagination helper.Pagination, userId int) (*helper.Pagination, error)
}
...
func (t transactionRepo) TransactionReportByMerchant(pagination helper.Pagination, userId int) (*helper.Pagination, error) {
	var transactions []*entity.Transaction
	...
	query.Count(&totalRows)
	query.Scopes(helper.PaginateQuery(&transactionByMerchant, &pagination, totalRows)).Find(&transactionByMerchant)
